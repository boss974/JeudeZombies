...
- Architecture
- Roadmap
- Stratégie dépendances
- Stratégie achats

## V0.2 - Prototype Roblox

- Lobby
- Téléporteur
- Arène
- Spawn simple des zombies
- Score temporaire
...
- Nettoyage des zombies morts
- Limite de zombies actifs

## V0.4 - Interface Roblox

- HUD score
- HUD vague
- Indicateur de vie
- Message début / fin de vague

## V0.5 - Progression Roblox

- Coins
- Meilleur score
- Sauvegarde DataStore
- Récompenses par zombie

## V0.6 - Boutique Roblox
...
Ne pas acheter d'assets avant que la boucle de jeu soit fun.
